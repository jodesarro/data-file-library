...
/*
  Imports 'double complex'-type data from a Tab-Separated Values data file and
...
*/
DATA_FILE_LIBRARY_API_IMPL_
void tsvdat_import_cplx(const char *file_path, tpdfcplx_impl_ *data)
#ifndef DATA_FILE_LIBRARY_IMPORTS
{
...
*/
DATA_FILE_LIBRARY_API_IMPL_
void tsvdat_export_cplx(const char *file_path, const tpdfcplx_impl_ *data,
